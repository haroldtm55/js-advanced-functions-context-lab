  ...
  describe("Given an employee record with a date-matched timeInEvent and timeOutEvent", function () {
    ...
    describe("hoursWorkedOnDate", function () {
      it("calculates that the employee worked 2 hours", function () {
        ...
        createTimeInEvent.call(cRecord, "0044-03-15 0900") //added two zeros at the beginning of the second argument as the time had the incorrect format
        createTimeOutEvent.call(cRecord, "0044-03-15 1100") //added two zeros at the beginning of the second argument as the time had the incorrect format
        expect(hoursWorkedOnDate.call(cRecord, "0044-03-15")).to.equal(2) //added two zeros at the beginning of the second argument as the time had the incorrect format
      })
    })
  })
  ...
  describe("Given an employee record with a date-matched timeInEvent and timeOutEvent", function () {
    ...
    describe("wagesEarnedOnDate", function () {
      it("calculates that the employee earned 54 dollars", function () {
        ...
        createTimeInEvent.call(cRecord, "0044-03-15 0900")//added two zeros at the beginning of the second argument as the time had the incorrect format
        createTimeOutEvent.call(cRecord, "0044-03-15 1100")//added two zeros at the beginning of the second argument as the time had the incorrect format
        expect(wagesEarnedOnDate.call(cRecord, "0044-03-15")).to.equal(54)//added two zeros at the beginning of the second argument as the time had the incorrect format
      })
      ...
      it("uses hoursWorkedOnDate", function() {
        ...
        createTimeInEvent.call(cRecord, "0044-03-15 0900")//added two zeros at the beginning of the second argument as the time had the incorrect format
        createTimeOutEvent.call(cRecord, "0044-03-15 1100")//added two zeros at the beginning of the second argument as the time had the incorrect format
        wagesEarnedOnDate.call(cRecord, "0044-03-15")//added two zeros at the beginning of the second argument as the time had the incorrect format
        expect(mySpy).to.have.been.called()
      })
    })
  })
  ...
  describe("Given an employee record with MULTIPLE date-matched timeInEvent and timeOutEvent", function () {
    ...
    describe("allWagesFor", function () {
      it("calculates that the employee earned 378 dollars", function () {
        cRecord = createEmployeeRecord(["Julius", "Caesar", "General", 27])
        // Earns 324
        createTimeInEvent.call(cRecord, "0044-03-14 0900")//added two zeros at the beginning of the second argument as the time had the incorrect format
        createTimeOutEvent.call(cRecord, "0044-03-14 2100")//added two zeros at the beginning of the second argument as the time had the incorrect format
        // Earns 54
        createTimeInEvent.call(cRecord, "0044-03-15 0900")//added two zeros at the beginning of the second argument as the time had the incorrect format
        createTimeOutEvent.call(cRecord, "0044-03-15 1100")//added two zeros at the beginning of the second argument as the time had the incorrect format
        // 324 + 54
